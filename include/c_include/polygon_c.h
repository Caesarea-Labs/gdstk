...
GDSTK_API void gdstk_polygon_get_repetition_spacing(const GDSTK_Polygon* polygon,
                                                    GDSTK_Vec2* spacing);
...
GDSTK_API void gdstk_polygon_get_repetition_offsets(const GDSTK_Polygon* polygon,
                                                    GDSTK_Vec2* offsets, uint64_t count);
GDSTK_API uint64_t gdstk_polygon_get_repetition_coords_count(const GDSTK_Polygon* polygon);
GDSTK_API void gdstk_polygon_get_repetition_coords(const GDSTK_Polygon* polygon, double* coords,
                                                   uint64_t count);
GDSTK_API uint64_t gdstk_polygon_repetition_get_count(const GDSTK_Polygon* polygon);

// Property getters
GDSTK_API GDSTK_PropertyValue* gdstk_polygon_get_property(const GDSTK_Polygon* polygon,
                                                          const char* name);
GDSTK_API GDSTK_PropertyValue* gdstk_polygon_get_gds_property(const GDSTK_Polygon* polygon,
                                                              uint16_t attribute);
...
GDSTK_API void gdstk_property_value_get_string(const GDSTK_PropertyValue* property, char* buffer,
...
GDSTK_API int gdstk_polygon_contain_all(const GDSTK_Polygon* polygon, const GDSTK_Vec2* points,
                                        uint64_t count);
GDSTK_API int gdstk_polygon_contain_any(const GDSTK_Polygon* polygon, const GDSTK_Vec2* points,
                                        uint64_t count);

// Bounding box
GDSTK_API void gdstk_polygon_bounding_box(const GDSTK_Polygon* polygon, GDSTK_Vec2* min,
                                          GDSTK_Vec2* max);

// Transformations
GDSTK_API void gdstk_polygon_translate(GDSTK_Polygon* polygon, const GDSTK_Vec2* v);
GDSTK_API void gdstk_polygon_scale(GDSTK_Polygon* polygon, const GDSTK_Vec2* scale,
                                   const GDSTK_Vec2* center);
GDSTK_API void gdstk_polygon_mirror(GDSTK_Polygon* polygon, const GDSTK_Vec2* p0,
                                    const GDSTK_Vec2* p1);
GDSTK_API void gdstk_polygon_rotate(GDSTK_Polygon* polygon, double angle, const GDSTK_Vec2* center);
GDSTK_API void gdstk_polygon_transform(GDSTK_Polygon* polygon, double magnification,
                                       int x_reflection, double rotation, const GDSTK_Vec2* origin);
...
GDSTK_API int gdstk_polygon_contour(const double* data, uint64_t rows, uint64_t cols, double level,
                                    double scaling, struct GDSTK_Array* result);
